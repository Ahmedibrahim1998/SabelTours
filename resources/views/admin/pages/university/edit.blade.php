...
@section('css')
@section('title')
    {{ trans('universities_trans.edit_university') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('universities.update', 'test') }}" method="post" enctype="multipart/form-data">
                                {{ method_field('patch') }}
                                @csrf
                                <div class="row font-weight-bold">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{$university->getTranslation('university_name', 'ar') }}"/>
                                    ...
                                    <div class="col font-weight-bold">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{$university->getTranslation('university_name', 'en') }}"/>
