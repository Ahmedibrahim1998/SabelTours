...
@section('css')
@section('title')
    {{ trans('socialLinks_trans.add_socialLinks') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('socialLinks.store','test') }}" method="POST"
                                ...
                                <div class="row font-weight-bold">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="position" id="position" class="form-control">
                                            ...
                                            <option value="up">{{trans('socialLinks_trans.up')}}</option>
                                            <option value="down">{{trans('socialLinks_trans.down')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <br><br>
