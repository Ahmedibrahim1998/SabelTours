...
@section('title')
    {{ __('sub_tours_trans.add_sub_tour') }}
@endsection
    ...
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <form action="{{ route('sub-tours.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="tour_id" class="form-control" required>
                                <option value="">{{ __('sub_tours_trans.select_tour') }}</option>
                        ...
                        <button type="submit" class="btn btn-primary">{{ __('sub_tours_trans.submit') }}</button>
                    </form>
                </div>
            </div>
        </div>
