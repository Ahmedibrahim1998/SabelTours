...
@section('content')
    <a href="{{ route('tour_details.create') }}" class="btn btn-success mb-3">
    ...
    <table class="table table-bordered text-center">
        ...
        <tr>
            ...
            <th>{{ __('tour_details_trans.title') }}</th>
            <th>{{ __('tour_details_trans.location') }}</th>
            <th>{{ __('tour_details_trans.image') }}</th>
            ...
            <tr>
                ...
                @php
                    $imageSrc = Illuminate\Support\Str::startsWith($detail->image, ['http://', 'https://'])
                        ? $detail->image
                        : asset('public/' . ltrim($detail->image, '/'));
                @endphp
                <td>
                    @if($detail->image)
                ...
                <td>
                    <a href="{{ route('tour_details.edit', $detail->id) }}" class="btn btn-info btn-sm"><i
                            class="fa fa-edit"></i></a>
                    <a href="{{ route('tour_details.show', $detail->id) }}" class="btn btn-secondary btn-sm"><i
                            class="fa fa-eye"></i></a>
                    <form action="{{ route('tour_details.destroy', $detail->id) }}" method="POST"
